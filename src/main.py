    ...
    def kolize(self):
        ...
        for zed in zdi:
            if zed.rect.x + zed.rect.w > hrac1.rect.x + hrac1.rect.w and zed.rect.x < hrac1.rect.x + hrac1.rect.w  and zed.rect.y + zed.rect.h > hrac1.rect.y and zed.rect.y < hrac1.rect.y or zed.rect.x + zed.rect.w > hrac1.rect.x and zed.rect.x < hrac1.rect.x and zed.rect.y + zed.rect.h > hrac1.rect.y + hrac1.rect.h and zed.rect.y < hrac1.rect.y + hrac1.rect.h or zed.rect.x + zed.rect.w > hrac1.rect.x and zed.rect.x < hrac1.rect.x and zed.rect.y + zed.rect.h > hrac1.rect.y and zed.rect.y < hrac1.rect.y or zed.rect.x + zed.rect.w > hrac1.rect.x + hrac1.rect.w and zed.rect.x < hrac1.rect.x + hrac1.rect.w and zed.rect.y + zed.rect.h > hrac1.rect.y + hrac1.rect.h and zed.rect.y < hrac1.rect.y + hrac1.rect.h:
                hrac1.otaceni = False
            if zed.rect.x + zed.rect.w > hrac2.rect.x + hrac2.rect.w and zed.rect.x < hrac2.rect.x + hrac2.rect.w  and zed.rect.y + zed.rect.h > hrac2.rect.y and zed.rect.y < hrac2.rect.y or zed.rect.x + zed.rect.w > hrac2.rect.x and zed.rect.x < hrac2.rect.x and zed.rect.y + zed.rect.h > hrac2.rect.y + hrac2.rect.h and zed.rect.y < hrac2.rect.y + hrac2.rect.h or zed.rect.x + zed.rect.w > hrac2.rect.x and zed.rect.x < hrac2.rect.x and zed.rect.y + zed.rect.h > hrac2.rect.y and zed.rect.y < hrac2.rect.y or zed.rect.x + zed.rect.w > hrac2.rect.x + hrac2.rect.w and zed.rect.x < hrac2.rect.x + hrac2.rect.w and zed.rect.y + zed.rect.h > hrac2.rect.y + hrac2.rect.h and zed.rect.y < hrac2.rect.y + hrac2.rect.h:
                hrac2.otaceni = False
